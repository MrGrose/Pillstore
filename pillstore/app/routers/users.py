...
from app.schemas.auth import UserCreate, UserResponse as UserSchema, RefreshTokenRequest
...
async def access_token(
    ...
    """
    Обновляет access-токен, принимая действующий refresh-токен в теле запроса.
    """
    credentials_exception = HTTPException(
        status_code=status.HTTP_401_UNAUTHORIZED,
        detail="Could not validate refresh token",
